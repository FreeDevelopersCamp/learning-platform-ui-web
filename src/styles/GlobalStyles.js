...
const GlobalStyles = createGlobalStyle`
    :root {
        ...
        ${'' /* --color-mutedblue-900: #e1e8f2; */}
            ...
            --color-teal-500: #20c997; /* Modern teal for buttons/accents */
            --color-purple-500: #a855f7; /* Attractive purple for focus states */
            --color-orange-500: #ff7a00; /* Vibrant orange for calls to action */
            --color-cyan-500: #17a2b8; /* Cool cyan for info states */
