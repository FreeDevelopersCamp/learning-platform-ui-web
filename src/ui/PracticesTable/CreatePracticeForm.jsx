...
import { useCreatePractice } from '../../apis/learn/Practice/hooks/useCreatePractice';
...
export default function CreatePracticeForm({ onCloseModal, instructorId }) {
  const { createPractice, isCreating } = useCreatePractice();
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <ButtonGroup>
          ...
          <Button type="submit" disabled={isCreating}>
            {isCreating ? <Spinner /> : 'Create Practice'}
          </Button>
        </ButtonGroup>
      </Form>
    </FormContainer>
